...
import ModalCreateVHost from './components/ModalCreateVHost'
                    ...
                    <div className="card bg-base-100 shadow-sm border border-base-200">
                        <div className="card-body p-6">
                            ...
                            <div className="mt-4 flex flex-col gap-3">
                                <QuickAction onClick={() => (document.getElementById("create_v_host") as HTMLDialogElement).showModal()} icon={Plus} label='Create vhost' />
